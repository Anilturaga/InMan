...
class ScreenComponentTwo extends React.Component {
  ...
  sendData = () => {
    if (this.state.shopName !== '') {
      ...
      var newShopName = this.state.shopName.replace(' ', '_');
      _shopDataUpload(
      ...
      this.setState({ error: 'Retailor name not given' });
    }
  };
  render() {
    const products = [];
                ...
                <View
                  ...
                  <View style={{ width: '40%' }}>
                    <TextInput
                      ...
                      onChangeText={text => this.setQuantity(text, index)}
                      keyboardType="numeric"
